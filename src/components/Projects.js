        ...
        <section className="py-20 px-10">
            ...
            <div  className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
                {projects.map((project, index) => (
                    <motion.div key={index} initial={{opacity: 0, y: 50}} whileInView={{opacity: 1, y: 0}} transition={{duration: 0.5, delay: index * 0.15}} viewport={{ once: true }} className="bg-zinc-900 rounded-xl p-6  hover:bg-zinc-800 transition-all duration-300 md:hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/20">
